(async function() {
    ...
    window._log && window._log("scriptPath=" + scriptPath);
    ...
    if (("undefined" != typeof EJS_DEBUG_XX && true === EJS_DEBUG_XX)) {
        ...
        window._log && window._log("loading emulator.min.js...");
    await loadScript("emulator.min.js");
    window._log && window._log("emulator.min.js done, EmulatorJS=" + typeof window.EmulatorJS);
        window._log && window._log("loading emulator.min.css...");
    await loadStyle("emulator.min.css");
    window._log && window._log("emulator.min.css done");
    }
    const config = {};
    ...
    window._log && window._log("creating EmulatorJS instance...");
    try {
        window.EJS_emulator = new EmulatorJS(EJS_player, config);
        window._log && window._log("EJS_emulator created! started=" + window.EJS_emulator.started);
    } catch(e) {
        window._log && window._log("ERROR: " + e.message + " | " + e.stack);
    }
